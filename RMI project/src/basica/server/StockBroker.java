...
public class StockBroker extends UnicastRemoteObject implements BrokerService {
     ...
     *
     * @param numberClients the number of clients which are going to connect to the server
    ...
    /**
     * Makes the action of buying share
     *
    ...
    public boolean sendQuotation() {
        ...
        try {
            ...
            System.out.println("Error al enviar una cotización");
            e.printStackTrace();
        }
        return true;
    }
